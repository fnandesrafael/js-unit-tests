...
describe('6 - Implemente os casos de teste para a função `productDetails`', () => {
  it('Verifica se a função `productDetails` tem o comportamento esperado', () => {
    ...
    assert.deepStrictEqual(productDetails()[0].details.productId, `${productDetails()[0].details.productId}`);
    assert.deepStrictEqual(productDetails()[1].details.productId, `${productDetails()[1].details.productId}`);
  });
});
